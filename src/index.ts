...
export = (app: Application) => {
  app.on(['pull_request.opened', 'pull_request.ready_for_review'], async (context: Context) => {
    ...
    // Do nothing if this is a draft PR
    if (context.payload.pull_request.draft) {
      context.log("skipping review assignment due to draft status");
      return;
    }
